...
class RegistrationControllerTest extends WebTestCase
{
    ...
    public function testRegister(): void
    {
        ...
        self::assertResponseRedirects('/login');  //@TODO: set the appropriate path that the user is redirected to.
        ...
        self::assertEmailAddressContains($messages[0], 'from', 'nardol.darren@gmail.com');
